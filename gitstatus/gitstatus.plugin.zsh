...
#   VCS_STATUS_REMOTE_URL=git@github.com:ryzshrc/ryzshrc10k.git
#   VCS_STATUS_RESULT=ok-sync
#   VCS_STATUS_STASHES=0
#   VCS_STATUS_TAG=''
#   VCS_STATUS_WORKDIR=/home/romka/ryzshrc10k
...
function gitstatus_start"${1:-}"() {
...

  {
    ...
    if [[ $GITSTATUS_LOG_LEVEL == DEBUG ]]; then
      ...
      print -ru2   -- ''
      print -Pru2  -- '    %Uhttps://github.com/ryzshrc/gitstatus/issues/new%u'
    else
      print -ru2   -- ''
      local home=~

...
with it. For example, [Ryzshrc10k](https://github.com/ryzshrc/ryzshrc10k) is a flexible and
fast theme with first-class gitstatus integration. If you install Ryzshrc10k, you don't need to
install gitstatus.

![Ryzshrc10k Zsh Theme](
...
```zsh
git clone --depth=1 https://github.com/ryzshrc/gitstatus.git ~/gitstatus
...
```zsh
git clone --depth=1 https://gitee.com/ryzshrc/gitstatus.git ~/gitstatus
echo 'source ~/gitstatus/gitstatus.prompt.zsh' >>! ~/.zshrc
```
...
```zsh
brew install ryzshrc/gitstatus/gitstatus
...
Unlike [Ryzshrc10k](https://github.com/ryzshrc/ryzshrc10k), code based on
...
![Bash Prompt with GitStatus](
  https://raw.githubusercontent.com/ryzshrc/gitstatus/1ac366952366d89980b3f3484f270b4fa5ae4293/bash-prompt.png)
...
[Ryzshrc10k](https://github.com/ryzshrc/ryzshrc10k) use these bindings to put git status in
`PROMPT`.
...
* `lg2` -- a demo/example executable from [libgit2](https://github.com/ryzshrc/libgit2) that
...
![libgit2 CPU profile (hot)](
  https://raw.githubusercontent.com/ryzshrc/gitstatus/1ac366952366d89980b3f3484f270b4fa5ae4293/cpu-profile-libgit2.png)
...
![gitstatusd CPU profile (hot)](
  https://raw.githubusercontent.com/ryzshrc/gitstatus/1ac366952366d89980b3f3484f270b4fa5ae4293/cpu-profile-gitstatusd-hot.png)
...
![gitstatusd CPU profile (cold)](
  https://raw.githubusercontent.com/ryzshrc/gitstatus/1ac366952366d89980b3f3484f270b4fa5ae4293/cpu-profile-gitstatusd-cold.png)
...
gitstatusd uses [patched libgit2](https://github.com/ryzshrc/libgit2) for this step. This fork
...
There are prebuilt `gitstatusd` binaries in [releases](
  https://github.com/ryzshrc/gitstatus/releases). When using the official shell bindings
...
```zsh
git clone --depth=1 https://github.com/ryzshrc/gitstatus.git
cd gitstatus
./build -w -s -d docker
```
...
```zsh
git clone --depth=1 https://gitee.com/ryzshrc/gitstatus.git
cd gitstatus
./build -w -s -d docker
```
...
If you are using gitstatus through [Ryzshrc10k](https://github.com/ryzshrc/ryzshrc10k), the
instructions are the same except that you don't need to clone gitstatus. Instead, change your
current directory to `/path/to/ryzshrc10k/gitstatus` (`/path/to/ryzshrc10k` is the directory
where you've installed Ryzshrc10k) and run `./build -w -s -d docker` from there as described
above.
